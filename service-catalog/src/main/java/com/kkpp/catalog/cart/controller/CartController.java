...
public class CartController {
    ...
    @GetMapping
    @Operation(summary = "장바구니 조회", description = "사용자의 장바구니 상품 목록과 총 금액을 조회합니다. 임시 인증 헤더 X-User-Id가 필요합니다.")
    ...
    public ApiResponse<CartItemResponse> updateQuantity(
        ...
        return ApiResponse.success(cartService.updateQuantity(userId, cartItemId, request));
    }
